...
# 화면 타이틀 설정
pygame.display.set_caption("Hello Pang")    # 게임 이름
...
while running:
    ...
    # 경과 시간 계산
    elapased_time = (pygame.time.get_ticks() - start_ticks) / 1000
    timer = game_font.render("Time : {}".format(int(total_time - elapased_time)), True, (255, 255, 255))
    screen.blit(timer, (10, 10))

    # 시간 초과했다면
    if total_time - elapased_time <= 0:
